...
namespace CarregarCotacoes
{
    public class PaginaCotacoes
    {
        ...
        public Historico ObterCotacoes()
        {
            List<Cotacao> cotacoes = new List<Cotacao>();

            Historico historicoCotacoes = new Historico();
            historicoCotacoes.DataExtracao = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
            historicoCotacoes.Cotacoes = cotacoes;
